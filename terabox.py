...
async def start_command(client: Client, message: Message):
    join_button = InlineKeyboardButton("ᴊᴏɪɴ 🛐", url="https://t.me/+Q0S4N4m44W43NDBl")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/TheW_ContactBot")
    repo69 = InlineKeyboardButton("Uɴsᴇᴇɴ Cᴏʟʟᴇᴄᴛɪᴏɴ 🔞", url="https://t.me/sugarvibes_s")
    user_mention = message.from_user.mention
    reply_markup = InlineKeyboardMarkup([[join_button, developer_button], [repo69]])
    final_msg = f"ᴡᴇʟᴄᴏᴍᴇ, {user_mention}.\n\n⛄ ɪ ᴀᴍ ᴀ ᴛᴇʀᴀʙᴏx ᴅᴏᴡɴʟᴏᴀᴅᴇʀ ʙᴏᴛ. sᴇɴᴅ ᴍᴇ ᴀɴʏ ᴛᴇʀᴀʙᴏx ʟɪɴᴋ ɪ ᴡɪʟʟ ᴅᴏᴡɴʟᴏᴀᴅ ᴡɪᴛʜɪɴ ғᴇᴡ sᴇᴄᴏɴᴅs ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴛᴏ ʏᴏᴜ 🎀."
    video_file_id = "/app/IMG_20250504_113600_431.jpg"
...
async def handle_message(client: Client, message: Message):
    ...
    if not is_member:
        join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/sugarvibes_s")
    ...
    caption = (
        ...
        "[ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜɢᴀʀ ᴠɪʙᴇs ⛄](https://t.me/sugarvibes_s)"
    )
